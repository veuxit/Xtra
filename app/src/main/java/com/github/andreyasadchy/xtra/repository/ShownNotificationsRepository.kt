...
class ShownNotificationsRepository @Inject constructor(
    ...
    suspend fun getNewStreams(notificationUsersRepository: NotificationUsersRepository, gqlHeaders: Map<String, String>, gqlApi: GraphQLRepository, helixHeaders: Map<String, String>, helixApi: HelixApi): List<Stream> = withContext(Dispatchers.IO) {
