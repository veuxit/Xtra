...
class ClipsFragment : BaseClipsFragment<ClipsViewModel>(), VideosSortDialog.OnFilter, FollowFragment {
    ...
    override fun initialize() {
        ...
        sortBar.setOnClickListener { VideosSortDialog.newInstance(period = viewModel.period, languageIndex = viewModel.languageIndex, clipChannel = arguments?.getString(C.CHANNEL_LOGIN) != null).show(childFragmentManager, null) }
        val activity = requireActivity() as MainActivity
