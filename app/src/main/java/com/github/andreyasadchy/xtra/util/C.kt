...
object C {
    ...
    const val API_PREFS_GAMES = "api_prefs_games"
    const val API_PREFS_STREAMS = "api_prefs_streams"
    const val API_PREFS_GAME_STREAMS = "api_prefs_game_streams"
    const val API_PREFS_GAME_VIDEOS = "api_prefs_game_videos"
    const val API_PREFS_GAME_CLIPS = "api_prefs_game_clips"
    const val API_PREFS_CHANNEL_VIDEOS = "api_prefs_channel_videos"
    const val API_PREFS_CHANNEL_CLIPS = "api_prefs_channel_clips"
    const val API_PREFS_SEARCH_VIDEOS = "api_prefs_search_videos"
    const val API_PREFS_SEARCH_STREAMS = "api_prefs_search_streams"
    const val API_PREFS_SEARCH_CHANNEL = "api_prefs_search_channel"
    const val API_PREFS_SEARCH_GAMES = "api_prefs_search_games"
    const val API_PREFS_FOLLOWED_STREAMS = "api_prefs_followed_streams"
    const val API_PREFS_FOLLOWED_VIDEOS = "api_prefs_followed_videos"
    const val API_PREFS_FOLLOWED_CHANNELS = "api_prefs_followed_channels"
    const val API_PREFS_FOLLOWED_GAMES = "api_prefs_followed_games"
