...
class ShownNotificationsRepository @Inject constructor(
    ...
    suspend fun getNewStreams(localFollowsChannel: LocalFollowChannelRepository, gqlHeaders: Map<String, String>, apolloClient: ApolloClient, helixHeaders: Map<String, String>, userId: String?, helixApi: HelixApi): List<Stream> = withContext(Dispatchers.IO) {
